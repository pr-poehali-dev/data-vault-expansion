          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                тысячи видеоэкранов по всей стране — размещайте рекламу{" "}
                <span className="font-serif italic">точно</span> там, где находится ваша аудитория
              </p>

              <div className="flex justify-center">
                <ShinyButton className="px-8 py-3 text-base">разместить рекламу</ShinyButton>
              </div>
            </div>
          </div>
        </section>
